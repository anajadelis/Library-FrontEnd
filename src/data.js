...
export const booksData = [
  {
    id: '1',
    image: Project1,
    name: 'A 5 Passos de Você',
    category: 'romance',
    description:'O Livro A Cinco Passos de Você é uma grande história de amor. Vivida por dois personagens adolescentes, o cenário se passa dentro de um ambiente hospitalar...',
  ...
  },
  {
    ...
    category: 'geek',
    description:'Então os olhos dela se fecharam, e fogo e caos e morte e ruído desapareceram. Assim como a mulher dos cabelos ruivos. NATASHA ROMANOFF é uma das assassinas mais letais do mundo...',
    href: 'https://www.ubook.com/ebook/616560/viuva-negra-vermelho-eterno',
  },
  {
    id: '3',
    image: Project3,
    name: 'O Extraordinário',
    category: 'drama',
    description:'August Pullman, o Auggie, nasceu com uma síndrome cuja sequela é uma severa deformidade facial, que lhe impôs diversas cirurgias e complicações médicas. Por isso ele nunca frequentou uma escola de verdade...',
  ...
  },
  {
    ...
    name: 'Amor e Gelato',
    category: 'romance',
    description:'Amor & Gelato é baseado no romance homônimo de Jenna Evans Welch. Lina está indo para a Itália, mas não porque quer, mas sim porquê o último desejo de sua mãe antes de morrer era que ela conhecesse seu pai...',
  ...
  },
  {
    ...
    category: 'romance',
    description:'Hazel é uma paciente terminal. Ainda que, por um milagre da medicina, seu tumor tenha encolhido bastante - o que lhe dá a promessa de viver mais alguns anos -, o último capítulo de sua história foi escrito no momento do diagnóstico...',
  ...
  },
  {
    ...
    name: 'Série Sandman',
    category: 'geek',
    description:'A história é vista do ponto de vista de Sonho, um dentre os sete perpétuos, a representação antropomórfica do sonho, inicialmente preso por um grupo de humanos que almejava prender sua irmã mais velha Morte para que se tornassem imortais, mas falham e capturam sonho...',
  ...
  },
  {
    ...
    name: 'Fahrenheit 451',
    category: 'sci',
    description:'Fahrenheit é contado em um futuro inespecífico em uma América hedonista e anti-intelectual que perdeu totalmente o controle. Qualquer um que é pego lendo livros é, no mínimo, confinado em um hospício...',
  ...
  },
  {
    ...
    name: 'Teto para Dois',
    category: 'romance',
    description:'Teto Para Dois nos traz a história de Tiffy, uma moradora de Londres que trabalha em uma editora especializada em livros de artesanato e do tipo “faça você mesmo”. Seu relacionamento com Justin terminou há três meses, mas ela ainda não conseguiu sair do apartamento do ex-namorado...',
  ...
  },
  {
    ...
    category: 'fantasy',
    description:'O Senhor dos Anéis (The Lord of the Rings, no original) é um livro de alta fantasia, escrito pelo escritor britânico J. R. R. Tolkien...',
  ...
  },
  {
    ...
    category: 'romance',
    description:'Orgulho e preconceito é a obra-prima da escritora britânica Jane Austen que tem como pano de fundo a burguesia inglesa do início do século XIX. Vemos no romance como as relações movidas por amor e dinheiro podem ser promíscuas e mesquinhas, encobertas pelo véu da sociedade burguesa...',
  ...
  },
  {
    ...
    category: 'fantasy',
    description:'As Crônicas de Nárnia apresentam, geralmente, as aventuras de crianças que desempenham um papel central e descobrem o ficcional Reino de Nárnia, um lugar onde a magia é corriqueira, os animais falam, e ocorrem batalhas entre o bem e o mal...',
  ...
  },
  {
    ...
    name: 'Matéria Escura',
    category: 'sci',
    description:'”Você está feliz com a vida que tem? Essas são as últimas palavras que Jason Dessen ouve antes de acordar num laboratório, preso a uma maca. Raptado por um homem mascarado, Jason é levado para uma usina abandonada e deixado inconsciente...',
  ...
  },
  {
    ...
    category: 'mistery',
    description:'Nessa história, Hercule Poirot embarca no Expresso do Oriente, um trem de luxo, que, devido a uma forte nevasca, precisa fazer uma parada no meio do caminho...',
  ...
  },
  {
    ...
    category: 'suspense',
    description:'A paciente silenciosa é um daqueles livros que não saem da cabeça do leitor, quer ele queira, quer não. Alicia Berenson tinha uma vida perfeita...',
    href: 'https://drive.google.com/file/d/1BFL3tKNtgBkwRyteRFR6AVVjzVdPResA/view?usp=sharing',
  },
  {
    id: '15',
    image: Project15,
    name: 'Um de nós está mentindo',
    category: 'suspense',
    description:'Em Um de Nós Está Mentindo, durante uma segunda-feira à tarde, cinco estudantes de Bayview High vão para a sala de detenção, mas apenas quatro deles saem de lá com vida...',
  ...
  },
  {
    ...
    name: 'O homem de Giz',
    category: 'mistery',
    description:'Enquanto os colegas liam Judy Blume, ela devorava as obras de Stephen King e James Herbert. Ao longo dos anos, atuou em várias funções, como repórter, redatora, roteirista para rádio, apresentadora de televisão, dubladora, passeadora de cães e agora escritora...',
  ...
  },
  {
    ...
    name: 'Coraline',
    category: 'horror',
    description:'Antes de começar o conto, Coraline e seus pais se mudam para um novo apartamento perto de uma floresta. Seus pais estão sempre ocupados com o trabalho e por isso lhe dão pouca atenção. Sentindo-se isolada, Coraline sai para explorar...',
    href: 'https://drive.google.com/file/d/1BwpGEcHUmPwNviHobGU8m53Vl9_connp/view?usp=sharing',
  },
  {
    id: '18',
    image: Project18,
    name: 'Loki: Onde Mora a Trapaça',
    category: 'geek',
    description:'O livro mostra um lado desconhecido de Loki, sensível e subestimado, e sua jornada para se tornar o anti-herói que conhecemos...',
    href: 'https://drive.google.com/file/d/1tW9i59I8z7h4r2oMKghDU4hvwCuh7Cjb/view?usp=sharing',
  },
  {
    id: '19',
    image: Project19,
    name: 'Batman: Os três Coringas',
    category: 'geek',
    description:'Como dito na sinopse, os três Morcegos acabam se encontrando durante a investigação que aponta os crimes supostamente assinados pelo Coringa...',
  ...
  },
  {
    ...
    name: 'It',
    category: 'horror',
    description:'It (em português A Coisa) é um romance de terror de 1986 do autor estadunidense Stephen King. Foi seu 22º livro e seu 17º romance escrito em seu próprio nome. A história segue as experiências de sete crianças, que são aterrorizadas por uma entidade maligna que explora os medos de suas vítimas para se disfarçar enquanto caçam suas presas...',
